...
export const metadata: Metadata = {
  ...
  description: 'NeuralEdge is a US-focused AI digital marketing agency offering AI website builds, SEO & GEO services, and UI/UX design. Get found on Google and cited by AI. Book your free audit today.',
  keywords: [
    'AI digital marketing agency USA',
    'SEO and GEO services United States',
    'AI website design agency',
    'generative engine optimization USA',
    'UI UX design agency America',
